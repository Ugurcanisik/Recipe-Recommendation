      ...
      <div class="animate form login_form">
        <section class="login_content">
          <form action="" method="POST">
            ...
            <div>
              <input type="text" class="form-control" name="usersurname" placeholder="Surname" required="" />
            </div>
            <div>
            ...
            <div>
              <input type="submit" style="margin-left:145px;" class="btn btn-primary" name="singup" value="Sing Up">
            </div>
